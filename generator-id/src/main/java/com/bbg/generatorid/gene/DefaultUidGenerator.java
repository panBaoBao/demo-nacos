...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    private static DefaultUidGenerator intance = null;//静态私用成员，没有初始化
    ...
    public static synchronized DefaultUidGenerator getInstance()    //静态，同步，公开访问点
    {
        if(intance == null)
        {
            intance = new DefaultUidGenerator();
        }
        return intance;
    }
    ...
    /** Spring property */
    protected WorkerIdAssigner workerIdAssigner = new SimpleWorkerIdAssigner();
    ...
    public void setEpochStr(String epochStr) {
        if (!StringUtils.isEmpty(epochStr)) {
            ...
            this.epochSeconds = TimeUnit.MILLISECONDS.toSeconds(DateUtil.parse(epochStr,"yyyy-MM-dd").getTime());
        }
    }
}