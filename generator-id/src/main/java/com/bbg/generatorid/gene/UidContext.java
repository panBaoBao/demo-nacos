...
public class UidContext {
    ...
    private BaiduUidStrategy uidStrategy;
    ...
    private static UidContext intance = null;//静态私用成员，没有初始化

    private UidContext(){
        this.uidStrategy = BaiduUidStrategy.getInstance();
    }

    public static synchronized UidContext getInstance()    //静态，同步，公开访问点
    {
        if(intance == null)
        {
            intance = new UidContext();
        }
        return intance;
    }
